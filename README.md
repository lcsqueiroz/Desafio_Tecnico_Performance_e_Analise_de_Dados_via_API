...
- [Exemplos de respostas esperadas na API](https://github.com/lcsqueiroz/Desafio_Tecnico_Performance_e_Analise_de_Dados_via_API/blob/main/exemplos-endpoints.json)
